...
// The system is composed of an item creator, an item manager, and a reports manager. 
...
// deleting items, and querying information about the items. Finally, the report manager 
// generates reports for a specific item or ALL items. Reports for specific items are 
// generated from report objects created from the report manager. The report manager is 
// responsible for reports for all items.

// Component Specifications
// Here's all the required information for an item:
// SKU code: This is the unique identifier for a product. It consists of the first 3 letters of the item and 
  // the first 2 letters of the category. If the item name consists of two words and the first word consists 
...
// The returned object has one method, itemInfo. It logs to the console all the properties of an object as "key:value" pairs 
  // (one pair per line). There are no other properties or methods on the returned object (except for properties/methods 
