// Rewrite the two following object types to use the class keyword, instead of direct prototype manipulation. 
// Person exposes a method greeting, which when called logs the provided greeting text. Shouter is a subtype of 
